...
<head>
    ...
    <title>COVID-19 Vaccinated Profiles</title>
</head>
<body>
    <header>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md">
                <br>
                <h1>Covid-19 Vaccinated Profiles</h1>
                <hr>
                <br>
                ...
                <div class="container data-table">
                    <table class="table table-borderless">
                        <tr>
                            ...
                            <th class="col-md-1"><h6>Vaccine 1</h6><hr></th>
                            <th class="col-md-1"><h6>Vaccine 2</h6><hr></th>
                            <th class="col-md-1"><h6>Vaccine 3</h6><hr></th>
            ...
            if(isset($_POST["btn-search"]))
				{
                    ...
                    $sql = "SELECT * FROM tbl_nic t1 ,tbl_vaccine t2 WHERE t1.nic = t2.nic and t1.nic ='".$search_value."'";
		  		...
		  		if(mysqli_num_rows($result1)>0)
				{
					...
					while($row1 = mysqli_fetch_assoc($result1)) 
					{
							...
							<td class="col-md-1">'.$row1['vacc1_name'].'</td>
                            <td class="col-md-1">'.$row1['vacc2_name'].'</td>
                            <td class="col-md-1">'.$row1['vacc3_name'].'</td>
                            ...
                            <td class="col-md-1"><a href="update_vaccinated_profiles.php?nic='.$row1['nic'].'"><button class="inadmin-edit-small-btn"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp; Update</button></td>
		    	...
		    	$sql = "SELECT * FROM tbl_nic t1 ,tbl_vaccine t2 WHERE t1.nic = t2.nic"; 
		  		...
		  		if(mysqli_num_rows($result)>0)
				{
					...
					while($row = mysqli_fetch_assoc($result)) 
					{
							...
							<td class="col-md-1">'.$row['vacc1_name'].'</td>
                            <td class="col-md-1">'.$row['vacc2_name'].'</td>
                            <td class="col-md-1">'.$row['vacc3_name'].'</td>
                            <td class="col-md-1"><a href="view_vaccinated_details.php?nic='.$row['nic'].'"><button class="inadmin-view-small-btn"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; View</button></td>
                            <td class="col-md-1"><a href="update_vaccinated_profiles.php?nic='.$row['nic'].'"><button class="inadmin-edit-small-btn"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp; Update</button></td>
