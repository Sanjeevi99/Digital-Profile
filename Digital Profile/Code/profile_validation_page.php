...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md">
                <br>
                <h1>Valid Digital Profiles</h1>
                <hr>
                <br>
                <form action="profile_validation_page.php" method="post" enctype="multipart/form-data">
            ...
            if(isset($_POST["btn-search"]))
		  		...
		  		if(mysqli_num_rows($result1)>0)
				{
					...
					while($row1 = mysqli_fetch_assoc($result1)) 
					{
                            ...
                            <td class="col-md-4"><a href="view_profiles.php?nic='.$row1['nic'].'"><button class="inadmin-view-btn"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;  View Profile</button></td>
		  		...
		  		if(mysqli_num_rows($result)>0)
				{
					...
					while($row = mysqli_fetch_assoc($result)) 
					{
                            ...
                            <td class="col-md-4"><a href="view_profiles.php?nic='.$row['nic'].'"><button class="inadmin-view-btn"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;  View Profile</button></td>
