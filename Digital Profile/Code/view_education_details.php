            ...
            $sql = "SELECT * FROM tbl_nic t1 ,tbl_al_results t2 WHERE t1.nic = t2.nic and t1.nic ='".$_GET['nic']."'";
		  		...
		  		if(mysqli_num_rows($result)>0)
				{
					...
					while($row = mysqli_fetch_assoc($result)) 
					{
                            ...
                            <br>
                            <h3 class="d-flex justify-content-center">G.C.E Advanced Level Details</h3>
                            <br>
                            <tbody>
                            ...
                            <td class="col-md">'.$row['indexnumber'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>year : </b></td>
                            <td class="col-md">'.$row['year'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>'.$row['sub1'].' :</b></td>
                            <td class="col-md">'.$row['result1'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>'.$row['sub2'].' :</b></td>
                            <td class="col-md">'.$row['result2'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>'.$row['sub3'].' :</b></td>
                            <td class="col-md">'.$row['result3'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>General English :</b></td>
                            <td class="col-md">'.$row['geneng'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>General Knowledge</b></td>
                            <td class="col-md">'.$row['gk'].'</td>
                            </tr>
                        <tbody>
						</table>
                        </div>
