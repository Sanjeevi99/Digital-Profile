            ...
            include_once('db_config.php');
		  		...
		  		if(mysqli_num_rows($result)>0)
				{
					...
					while($row = mysqli_fetch_assoc($result)) 
					{
                            ...
                            <br>
                            <h3 class="d-flex justify-content-center">NIC Details</h3>
                            <br>
                            <tbody>
                            ...
                            <td class="col-md">'.(decryptthis($row['dob'],$key)).'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Address : </b></td>
                            <td class="col-md">'.(decryptthis($row['address'],$key)).'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Occupation : </b></td>
                            <td class="col-md">'.(decryptthis($row['occupation'],$key)).'</td>
                            </tr>
                        <tbody>
						</table>
                        </div>
