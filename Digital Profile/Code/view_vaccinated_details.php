...
<head>
    ...
    <title>View Vaccinated details</title>
</head>
<body>
    <header>
            ...
            $sql = "SELECT * FROM tbl_nic t1 ,tbl_vaccine t2 WHERE t1.nic = t2.nic and t1.nic ='".$_GET['nic']."'";
		  		...
		  		if(mysqli_num_rows($result)>0)
				{
					...
					while($row = mysqli_fetch_assoc($result)) 
					{
                            ...
                            <br>
                            <h3 class="d-flex justify-content-center">Vaccination Details</h3>
                            <br>
                            <tbody>
                            ...
                            <td class="col-md">'.$row['vacc1_name'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Vaccinated Date : </b></td>
                            <td class="col-md">'.$row['vacc1_date'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Vaccinated Place : </b></td>
                            <td class="col-md">'.$row['vacc1_place'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Vaccine 2 Name : </b></td>
                            <td class="col-md">'.$row['vacc2_name'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Vaccinated Date : </b></td>
                            <td class="col-md">'.$row['vacc2_date'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Vaccinated Place : </b></td>
                            <td class="col-md">'.$row['vacc2_place'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Vaccine 3 Name : </b></td>
                            <td class="col-md">'.$row['vacc3_name'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Vaccinated Date : </b></td>
                            <td class="col-md">'.$row['vacc3_date'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>Vaccinated Place : </b></td>
                            <td class="col-md">'.$row['vacc3_place'].'</td>
                            </tr>
                            <tr>
							<td class="col-md"><b>No.of Vaccine Taken : </b></td>
                            <td class="col-md">'.$row['no_of_vacc_taken'].'</td>
                            </tr>
                        <tbody>
						</table>
                        </div>
