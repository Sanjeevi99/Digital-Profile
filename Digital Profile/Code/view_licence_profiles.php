...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md">
                <br>
                <h1>Licence Profiles</h1>
                <hr>
                <br>
                <form action="view_licence_profiles.php" method="post" enctype="multipart/form-data">
                <div class="container d-flex flex-row">
                    <input class="search-bar" type="text" name="search-val" id="search-val" style="font-family: FontAwesome;" placeholder='&#xf002  Search Licence Profiles'>
                ...
                <div class="container data-table">
                    <table class="table table-borderless">
                        <tr>
                            ...
                            <th class="col-md-2"><h6>Licence No</h6><hr></th>
            ...
            if(isset($_POST["btn-search"]))
				{
                    ...
                    $sql = "SELECT * FROM tbl_nic t1 ,tbl_licence t2 WHERE t1.nic = t2.nic and t1.nic ='".$search_value."'";
		  		...
		  		if(mysqli_num_rows($result1)>0)
				{
					...
					while($row1 = mysqli_fetch_assoc($result1)) 
					{
                            ...
                            <td class="col-md-2">'.$row1['licence_no'].'</td>
                            <td class="col-md-1"><a href="view_licence_details.php?nic='.$row1['nic'].'"><button class="inadmin-view-small-btn"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; View</button></td>
                            <td class="col-md-1"><a href="update_licence_profiles.php?nic='.$row1['nic'].'"><button class="inadmin-edit-small-btn"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp; Update</button></td>
		    	...
		    	$sql = "SELECT * FROM tbl_nic t1 ,tbl_licence t2 WHERE t1.nic = t2.nic"; 
		  		...
		  		if(mysqli_num_rows($result)>0)
				{
					...
					while($row = mysqli_fetch_assoc($result)) 
					{
                            ...
                            <td class="col-md-2">'.$row['licence_no'].'</td>
                            <td class="col-md-1"><a href="view_licence_details.php?nic='.$row['nic'].'"><button class="inadmin-view-small-btn"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; View</button></td>
                            <td class="col-md-1"><a href="update_licence_profiles.php?nic='.$row['nic'].'"><button class="inadmin-edit-small-btn"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp; Update</button></td>
