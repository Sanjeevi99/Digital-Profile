 ...
 function generateCard() {
    ...
    let qrValue2 = document.getElementById("Vaccine").value;
     ...
     document.getElementById("Name").innerHTML = nameValue;
      ...
      document.getElementById("img").src = `https://api.qrserver.com/v1/create-qr-code/?size=100x100&data= Name: ${nameValue}, Vaccine 1: ${vacc1_name}, Vaccine 2: ${vacc2_name}, Vaccine 3: ${vacc3_name}`;
